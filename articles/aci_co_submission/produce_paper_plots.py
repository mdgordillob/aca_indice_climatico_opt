...
def fig4_national_aci(df_col: pd.DataFrame, oni: pd.Series):
    ...
    if _boot_csv.exists():
        ...
        boot_legend = [
            mpatches.Patch(color="steelblue", alpha=0.45, label="90 % baseline variability band"),
            mpatches.Patch(color="steelblue", alpha=0.65, label="50 % baseline variability band"),
        ]
